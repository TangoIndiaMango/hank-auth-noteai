...
import { Bold, Code, CodepenIcon, Heading1, Heading2, Heading4, Heading6, Italic, List, ListOrdered, Quote, Redo, Strikethrough, Undo } from 'lucide-react'
...
const TipTapMenuBar = ({ editor }: Props) => {
    return (
        <div className="flex flex-wrap gap-2">
            ...
            <button onClick={() => editor.chain().focus().toggleCodeBlock().run()} disabled={!editor.can().chain().focus().toggleCodeBlock().run()}
